...
{
    internal sealed class CircularProgressionTimed : Control
    {
        //int Minimum = 0;
        //int Maximum = 100;
        //int Value = 1;
        ...
        private Bitmap DrawArc(int width, int height, double seconds)
        {
            ...
            using (Graphics newGraphics = Graphics.FromImage(bmp))
            {
                ...
                using (var pnTrack = new System.Drawing.Pen(TrackColor, TrackSize))
                {
        ...
        public CircularProgressionTimed(int radius, DateTime start, DateTime finish, int itemId, int itemHue, int previewOffsetX, int previewOffsetY, int circleOffsetHeight)
        {
            //_Seconds = seconds;
        ...
        public override bool Draw(UltimaBatcher2D batcher, int x, int y)
        {
            if (!IsDisposed)
            {
                ...
                (
                    ...
                    ShaderHueTranslator.GetHueVector(CountdownHue, false, Alpha)
                );
                ...
                if (!string.IsNullOrEmpty(TextLabel))
                {
                    ...
                    (
                        ...
                        ShaderHueTranslator.GetHueVector(TextHue, false, Alpha)
                    );
                }
            }
